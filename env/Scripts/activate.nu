...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\amadeo\OneDrive\Escritorio\Introduccion\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\amadeo\OneDrive\Escritorio\Introduccion\env\Scripts\deactivate.nu'
